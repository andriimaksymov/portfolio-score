...
export default function FeaturedProjectWidget({ analysis }: FeaturedProjectWidgetProps) {
  ...
  const project = {
    ...
    technologies: ['React', 'TypeScript', 'Node.js'], // Mocked as data is not yet in type
    stars: 12, // Mocked
    url: '#', // Mocked
    suggestion: flagship?.improvements?.[0] || 'Add a detailed contribution guide to attract more open-source developers.'
  };
