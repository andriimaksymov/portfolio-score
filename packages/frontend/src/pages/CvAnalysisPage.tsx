...
import { Box, Paper, Typography, CircularProgress, Button, Grid, Chip } from '@mui/material';
       ...
       <Grid container spacing={4}>
         ...
         <Grid item xs={12} md={5}>
            <Paper sx={{ p: 3, height: '80vh', overflowY: 'auto' }}>
               <Typography variant="h5" gutterBottom fontWeight="bold">AI Critique</Typography>
               
               {/* Summary Score */}
               <Box sx={{ mb: 4, mt: 2 }}>
                  <Typography variant="subtitle2" color="text.secondary">PROFESSIONAL SCORE</Typography>
         ...
         <Grid item xs={12} md={7}>
            <Paper sx={{ p: 4, height: '80vh', overflowY: 'auto', bgcolor: '#fafafa' }}>
